...
const ErrorPage = () => {
    return (
        <section className="flex items-center h-full p-16 bg-base-600 text-gray-900">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
            <div className="max-w-md text-center">
                <h2 className="mb-8 font-extrabold text-5xl dark:text-gray-600">
                    <span className="sr-only">Error</span>404
                </h2>
                <p className="text-2xl font-semibold md:text-2xl">Sorry, we couldn't find this page.</p>
